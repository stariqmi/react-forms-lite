            ...
            switch (type) {
                ...
                case 'select':
                    ...
                    element = _react2.default.createElement(
                        'select',
                        { key: this.props.id, value: '', onChange: this.update },
                        options
                    );
                    break;
                case 'textarea':
                    element = _react2.default.createElement('textarea', { key: this.props.id, onChange: this.update });
                    break;
                default:
