...
var MyDatePicker = function (_React$Component) {
    _inherits(MyDatePicker, _React$Component);

    function MyDatePicker(props) {
        _classCallCheck(this, MyDatePicker);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MyDatePicker).call(this, props));
